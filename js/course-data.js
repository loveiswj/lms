...
var CHAPTERS = {
  ...
  4:  [
    ...
    {time:24,  label:"그룹 유형 변경"},
    {time:44,  label:"데이터 그룹 설정"},
    {time:107, label:"데이터 필터링"},
    {time:124, label:"표 확장/축소"},
    {time:138, label:"다중 값 분석"},
    {time:150, label:"상세 데이터 조회"}
  ],
  5:  [
    {time:0,  label:"소개"},
    {time:7,  label:"차트 활성화"},
  ...
  8:  [
    ...
    {time:116, label:"피벗 테이블 수정"},
    {time:149, label:"슬라이서 삽입"},
    {time:183, label:"상세 데이터 조회"},
    {time:191, label:"보고서 저장"}
  ],
  9:  [
    {time:0,   label:"목표화면 소개"},
    {time:29,  label:"실습용 엑셀 파일 다운로드"},
    {time:53,  label:"변수 정의"},
    {time:102, label:"데이터 파생항목 작성"},
    {time:123, label:"데이터 집계"},
    {time:340, label:"서식 설정"},
    {time:391, label:"데이터 집계"},
    {time:497, label:"차트 설정"},
    {time:515, label:"템플릿 보고서 저장 및 편집"},
    {time:552, label:"엑셀 파일 업로드"},
    {time:576, label:"엑셀 디자인 실행"},
    {time:584, label:"데이터 가져오기"},
    {time:708, label:"엑셀 디자인 저장 및 결과 조회"},
  ...
  10: [
    ...
    {time:89,  label:"엑셀 파일 업로드"},
    {time:103, label:"엑셀 디자인 실행"},
    {time:113, label:"데이터 가져오기"},
    {time:169, label:"변수 정의"},
    {time:254, label:"데이터 집계"},
    {time:636, label:"서식 설정"},
    {time:669, label:"행 숨김 및 엑셀 디자인 저장"},
    {time:690, label:"저장 결과 조회"},
    {time:698, label:"조회 버튼 동작 설정"},
    {time:736, label:"보고서 저장"}
  ],
  11: [
    {time:4,   label:"목표화면 소개"},
    {time:30,  label:"실습용 엑셀 파일 다운로드"},
    {time:56,  label:"템플릿 보고서 저장 및 편집"},
    {time:89,  label:"엑셀 파일 업로드"},
    {time:95,  label:"엑셀 디자인 실행"},
    {time:110, label:"변수 정의"},
    {time:168, label:"데이터 가져오기"},
    {time:229, label:"데이터 파생항목 작성"},
    {time:292, label:"V1시트 데이터 집계"},
    {time:361, label:"V1시트 서식 설정"},
    {time:409, label:"V2 시트 데이터 집계 및 서식 설정"},
    {time:593, label:"V2 시트 서식 설정"},
    {time:649, label:"전년 누계 대비 데이터 집계"},
    {time:733, label:"서식 설정"},
    {time:751, label:"엑셀 디자인 저장 및 결과 조회"},
  ...
  12: [
    ...
    {time:244, label:"조회 수식 자동화(UI Bot)"},
  ...
  13: [
    ...
    {time:36,  label:"엑셀 파일 실행"},
    {time:48,  label:"기준 일자 및 날짜 구분 값 작성"},
    {time:194, label:"가상 데이터 생성하기"},
    {time:243, label:"데이터 파생항목 작성"},
    {time:293, label:"데이터 집계"},
    {time:557, label:"보고서 기능 동작 확인"}
  ],
  14: [
    {time:3,   label:"목표화면 소개"},
    {time:35,  label:"템플릿 보고서 저장 및 편집"},
    {time:67,  label:"엑셀 디자인 실행"},
    {time:73,  label:"변수 정의"},
    {time:112, label:"데이터 가져오기"},
    {time:177, label:"데이터 파생항목 작성"},
    {time:227, label:"데이터 집계"},
    {time:323, label:"엑셀 디자인 저장"},
  ...
  15: [
    ...
    {time:131, label:"Chart 클릭 팝업 동작 설정"},
  ...
  20: [
    ...
    {time:365, label:"열 숨기기 취소"},
    {time:370, label:"실행 계획 작성"},
    {time:419, label:"버튼 동작 설정"},
    {time:447, label:"입력 대상 셀 잠금 해제"},
